...
if (isset($_GET["sil"])) {
    ...
    if (mysqli_num_rows($kontrolSonuc) > 0) {
        ...
        echo "<script>alert('Bu güzergah başka bir otobüs tarafından kullanılıyor.')</script>";
...
//otobusler tablosundaki guzergah_id ile guzergah tablosundaki guzergah_id aynı olanları birleştir
...
<body>
    ...
    <section class="ana">
        ...
        <table>
            ...
            <?php $sira = 0 ?>
            <?php while ($dizi = mysqli_fetch_assoc($sonuc)) {
                $sira++ ?>
                <tr class="guzergahtr">
                    <td><?php echo $sira ?></td>
                    ...
                    <td>
                        <a href="">🖋️</a>
                        <a href="guzergah.php?sil=<?php echo $dizi["guzergah_id"] ?>"
                            onclick="return confirm('Bu güzergah verisini silmek istediğinize eminmisiniz?')">🗑️</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
